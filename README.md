...
2. However, I would like the whole app to be deployed with AWS and a database to be permament. So, I created and configureed a cloud database on RDS (DB endpoint: dbemployees.c7xfh2nmelwl.us-east-1.rds.amazonaws.com). Then, I connected this cloud database with the back-end Spring part of this app. 
